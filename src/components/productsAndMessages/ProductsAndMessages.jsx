        ...
        <div className='p-3 d-flex justify-content-evenly align-items-center'>
          ...
          <div className='col-2'>
            {theme === 'darkSide' ? (
              <img
                className='img-size'
                src='https://res.cloudinary.com/marangadev/image/upload/v1691095509/portfolio/vaderToy_uojbtf.png'
                alt='LegoVader'
              />
            ) : (
              <img
                className='img-size ShadowImg'
                src='https://res.cloudinary.com/marangadev/image/upload/v1691095505/portfolio/Lego-Luke_wkyka2.png'
                alt='LegoLuke'
              />
            )}
          </div>
