	...
	return (
		<div className={
			...
			<div className='col-12 d-flex flex-column flex-md-row justify-content-evenly'>
				...
				<div className='col-12 col-md-4 d-flex flex-column align-items-md-center justify-content-md-center gap-1'>  <h2 className={ theme === 'darkSide' ? 'text-light p-2 text-center my-1 rounded' : 'p-2 text-center my-1 rounded  fw-bold' }>#Consultora Cc Web</h2>
					...
					<p className={ theme === 'darkSide' ? 'text-light p-2 text-center my-1 rounded' : 'p-2 text-center my-1 rounded  fw-bold' }>{ language === 'es' ? es.description.consultora : en.description.consultora }</p>
				</div>

				<iframe src="https://consultoracc.netlify.app/" id="iframe" loading="lazy" className={ theme === 'darkSide'
        ...
        <a
          ...
          <i
			...
			<div
				className='p-3 col-12 rounded d-flex justify-content-evenly align-items-center'>
